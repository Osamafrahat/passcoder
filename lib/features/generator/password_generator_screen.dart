...
class _PasswordGeneratorScreenState extends State<PasswordGeneratorScreen> {
  ...
  void _generatePassword() {
    ...
    _generatedPassword = List.generate(_passwordLength, (_) => chars[Random.secure().nextInt(chars.length)]).join();
    _calculateStrength();
    setState(() {});
  }
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Container(
          ...
          child: Column(children: [
            SelectableText(_generatedPassword, style: const TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.w600, letterSpacing: 1.5), textAlign: TextAlign.center),
        ...
        Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Slider(value: _passwordLength.toDouble(), min: 6, max: 64, onChanged: (v) { _passwordLength = v.round(); _generatePassword(); }, activeColor: theme.colorScheme.primary),
            ...
            const SizedBox(height: 8),
            ClipRRect(borderRadius: BorderRadius.circular(4), child: LinearProgressIndicator(value: _strength, backgroundColor: theme.colorScheme.surfaceContainerHighest, color: _strengthColor(), minHeight: 6)),
          ]),
        ),
        const SizedBox(height: 20),
        Container(
